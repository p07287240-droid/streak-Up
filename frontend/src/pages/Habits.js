    ...
    <div className="dashboard">
      ...
      <section className="user-bar">
        ...
        <form className="add-habit-form" onSubmit={addHabit}>
          <input type="text" placeholder="Enter a new habit..." value={title} onChange={(e) =>setTitle(e.target.value)}/>
      ...
      <main className="habits-section">
        <div className="section-heading">
          ...
          <span className="habit-count">
            {habits.length}{" "}
            {habits.length === 1 ? "habit": "habits"}</span>
        </div>
            ...
            habits.map((habit) => {
              ...
              return (
                <div className="habit-card" key={habit._id}>
                  ...
                  <button className="delete-button"onClick={() =>deleteHabit(habit._id)}>×</button>
                  </div>
                  ...
                  <button
                    className={checkedToday? "check-button checked": "check-button" }
      ...
      <footer className="api-footer">
        <span className="api-title">API FLOW</span>
